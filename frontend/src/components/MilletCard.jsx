...
const MilletCard = ({ millet }) => {
  return (
    <div className="bg-white rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-500 border border-secondary/10 overflow-hidden flex flex-col h-full hover:-translate-y-2 transform ring-1 ring-primary/5 hover:ring-primary/20">
      <div className="bg-primary/5 p-6 border-b border-primary/10 relative overflow-hidden">
        <div className="absolute top-0 right-0 p-4 opacity-10 flex -mt-6 -mr-6">
